...
{  
    ...
    {        
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            m_ellipses[for_ellipse].Show(gr = CreateGraphics(), Color.Aquamarine); //заполнение массива объектов одной группы
            for_ellipse++;
        ...
        private void button16_Click(object sender, EventArgs e)// создание ромба
        {
            ...
            m_rhomb[for_rhomb].Show(gr = CreateGraphics(), Color.Aquamarine);
            for_rhomb++;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in checkedListBox1.Items.OfType<string>().ToList())
            {
                ...
                {                    
                    m_ellipses[int.Parse(item.Replace("Эллипс", ""))].Show(gr, Color.Aquamarine);
                }
                else if (item.Contains("Ромб"))
                {
                    m_rhomb[int.Parse(item.Replace("Ромб", ""))].Show(gr, Color.Aquamarine);
                }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in checkedListBox1.Items.OfType<string>().ToList())
            {
                ...
                else if (item.Contains("Ромб"))
                {
                    ...
                    if (checkedListBox1.GetItemChecked(i))
                    {
                        m_rhomb[int.Parse(item.Replace("Ромб", ""))].Move(move_pixels, 0);
                    }
                    m_rhomb[int.Parse(item.Replace("Ромб", ""))].Show(gr, Color.Aquamarine);
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in checkedListBox1.Items.OfType<string>().ToList())
            {
                ...
                else if (item.Contains("Ромб"))
                {
                    ...
                    if (checkedListBox1.GetItemChecked(i))
                    {
                        m_rhomb[int.Parse(item.Replace("Ромб", ""))].Move(0, move_pixels);
                    }
                    m_rhomb[int.Parse(item.Replace("Ромб", ""))].Show(gr, Color.Aquamarine);
